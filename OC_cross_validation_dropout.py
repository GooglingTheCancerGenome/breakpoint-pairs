...
def main():
    ...
    output_dir_test = datapath_prefix+'NA12878_CNN_results_'+str(int(args.split*100))+'_'+str(args.epochs)+'_'+str(args.learningrate)+"_"+args.caller+"_"+str(drp1*100)+"_"+str(drp2*100)
