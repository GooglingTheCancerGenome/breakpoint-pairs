...
def main():
    ...
    if HPC_MODE:
        if args.stacked == "y":
            datapath_training = datapath_traintest + "N12878_DEL_NEWTrainingData_" + args.caller + "_stacked.npz"
            datapath_test = datapath_traintest + "N12878_DEL_NEWTestData_" + args.caller + "_stacked.npz"
        else:
