...
np.savez("N12878_DEL_TrainingData", X=windowpairs_all, y=labels_all, y_binary=y_train_binary, ids=ids_all)
np.savez("N12878_DEL_TestData", X=test_set_windowpairs_all, y=test_set_labels_all, y_binary=y_test_binary, ids=test_set_ids_all)
